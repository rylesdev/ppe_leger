...
foreach ($lesCommandes as $uneCommande) {
    $promotion = array_filter($livresPromotion, fn($p) => $p['idLivre'] === $uneCommande['idLivre']);
    $prix = $promotion ? current($promotion)['prixPromotion'] : $uneCommande['prixLivre'];
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <?php foreach ($lesCommandes as $uneCommande):
                    $promotion = array_filter($livresPromotion, fn($p) => $p['idLivre'] === $uneCommande['idLivre']);
                    $prixAffichage = $promotion ? current($promotion)['prixPromotion'] : $uneCommande['prixLivre'];
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($promotion): ?>
                                <span class="old-price"><?= $uneCommande['prixLivre'] ?>€</span>
                                <span class="promo-price"><?= $prixAffichage ?>€</span>
                            <?php else: ?>
                                <?= $prixAffichage ?>€
                            <?php endif; ?>
                        </td>
