    ...
    <div class="overflow-x-auto shadow-lg rounded-lg border border-gray-200">
        <table class="w-full" style="table-layout: fixed;">
            ...
            <tr class="bg-blue-900 text-white">
                ...
                <th scope="col" class="px-4 py-3 text-left" style="width: 200px">Opérations</th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            if (isset($lesLivres)) {
                ...
                foreach ($lesLivres as $unLivre) {
                    ...
                    echo "<td class='px-4 py-4' style='width: 200px; white-space: nowrap'>";
                    if (isset($isAdmin) && $isAdmin == 1) {
                        ...
                        if (!isset($_SESSION['emailUser'])) {
                            ...
                            echo "<input type='number' name='quantiteLivre' min='1' max='".$unLivre['exemplaireLivre']."' value='1' class='border border-gray-300 rounded w-16 p-1 text-center'>";
                            echo "<button type='submit' name='action' value='AjouterPanier' class='bg-blue-900 hover:bg-blue-800 text-white px-3 py-1 rounded flex items-center transition duration-200'>";
