    ...
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-3xl mx-auto">
        <?php if ($laPromotion != null): ?>
            <form method="post" class="space-y-6" id="promotionForm">
                ...
                <input type="hidden" name="idLivre" value="<?= htmlspecialchars($laPromotion['idLivre'] ?? '') ?>">
                ...
                <div class="flex justify-between items-center pt-4">
                    ...
                    <button type="submit" name="ValiderPromotion"
        ...
        <?php else: ?>
            <p class="text-gray-700 text-sm font-bold mb-2">Sélectionner un livre pour modifier sa promotion</p>
        <?php endif; ?>
    </div>
</div>
