            ...
            <table>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <input type="submit" name="UpdateParticulier" value="Mettre à jour"
                               style="background-color: #2E6E49; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;" class="btn">
                    </td>
                </tr>
            </table>
        </form>
        ...
        <form method="post">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="number" class="form-control" id="capitalSocialUser" name="capitalSocialUser"
                            step="0.01" min="0" required></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <input type="submit" name="UpdateEntreprise" value="Mettre à jour"
                               style="background-color: #2E6E49; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer;" class="btn">
                    </td>
                </tr>
            </table>
